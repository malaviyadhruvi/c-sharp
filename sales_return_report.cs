    ...
    public partial class sales_return_report : Form
    {
        ...
        private void radioButton1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (radioButton1.Checked == true)
            {
                ...
                id_cmb.Items.Clear();
                id_cmb.Visible = true;
                cmd = new OleDbCommand("select pid from sales_return", con);
        ...
        private void radioButton2_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (radioButton2.Checked == true)
            {
                ...
                nm_cmb.Items.Clear();
                nm_cmb.Visible = true;
                cmd = new OleDbCommand("select pnm from sales_return", con);
                adp = new OleDbDataAdapter(cmd);
                ds = new DataSet();
                adp.Fill(ds);
                con.Close();
        ...
        {
            string st = Application.StartupPath + "\\report\\sales_return.rpt";
            axCrystalReport1.ReportFileName = st;

            if (radioButton1.Checked == true)
            {
                string str = Application.StartupPath + "\\report\\sales_return.rpt";
                axCrystalReport1.ReportFileName = str;

                axCrystalReport1.SelectionFormula = "{ sales_return.pid}=" + id_cmb.Text + "";
            }
            else if (radioButton2.Checked == true)
            {
                string str = Application.StartupPath + "\\report\\purches_report.rpt";
                axCrystalReport1.ReportFileName = str;
                axCrystalReport1.SelectionFormula = "{ sales_return.pnm}='" + nm_cmb.Text + "' ";
            }
            else
            {
                axCrystalReport1.SelectionFormula = "{sales_return.pid}>0";
            }
